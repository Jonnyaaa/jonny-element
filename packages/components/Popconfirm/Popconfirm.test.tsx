...
describe("Popconfirm/index.ts", () => {
  ...
  it("should be exported with withInstall()", () => {
    expect(JoPopconfirm.install).toBeDefined();
  });

  // 测试 Popconfirm 组件是否被正确导出
  it("should be exported Popconfirm component", () => {
    expect(JoPopconfirm).toBe(PopConfirm);
  });
  ...
  test("should enhance Popconfirm component", () => {
    ...
    expect(enhancedPopconfirm).toBe(JoPopconfirm);
...
describe("Popconfirm.vue", () => {
  ...
  test("popconfirm emits", async () => {
    ...
    expect(wrapper.find(".jo-popconfirm").exists()).toBeTruthy();
    const confirmBtn = wrapper.find(".jo-popconfirm__confirm");
    expect(confirmBtn.exists()).toBeTruthy()

    confirmBtn.trigger("click");
    await vi.runAllTimers();
    expect(wrapper.find(".jo-popconfirm").exists()).toBeFalsy();
    ...
    const cancelBtn = wrapper.find(".jo-popconfirm__cancel");
