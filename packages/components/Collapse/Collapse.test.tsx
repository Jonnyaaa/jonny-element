...
describe("Collapse.vue", () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll(".jo-collapse-item__header");
    contents = wrapper.findAll(".jo-collapse-item__wapper");
  ...
  test("手风琴模式 错误处理", () => {
    ...
    expect(warn.mock.calls).toMatchInlineSnapshot(
      `
        [
          [
            [JoUIError: [JoCollapse]:accordion mode should only have one active item],
          ],
        ]
      `
    );
