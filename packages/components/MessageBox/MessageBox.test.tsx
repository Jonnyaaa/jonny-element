...
describe("MessageBox Component", () => {
  it("renders correctly", async () => {
    ...
    MessageBox(props);
    await rAF();
    const header = document.querySelector(".jo-message-box__header");
    const title = document.querySelector(".jo-message-box__title");
    const message = document.querySelector(".jo-message-box__message");
