...
import { type DropdownItemProps } from "jonny-element";
...
<template>
  <div class="row">
    <div class="col">
      ...
      <jo-dropdown :items="items">
        <span class="dropdown-link">
          Dropdown List
          <jo-icon icon="angle-down" />
        </span>
      </jo-dropdown>
    </div>
    <div class="col">
      <div class="desc">click to trigger</div>
      <jo-dropdown :items="items" trigger="click">
        <span class="dropdown-link">
          Dropdown List
          <jo-icon icon="angle-down" />
        </span>
    ...
    <div class="col">
      ...
      <jo-dropdown :items="items" trigger="contextmenu">
        <span class="dropdown-link">
          Dropdown List
          <jo-icon icon="angle-down" />
        </span>
...
.desc {
  display: block;
  color: var(--jo-text-color-secondary);
  font-size: 14px;
  margin-bottom: 20px;
}
.dropdown-link {
